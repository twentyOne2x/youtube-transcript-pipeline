...
from src import root_dir, YOUTUBE_VIDEO_DIRECTORY
from src.constants import *
from src.data_ingestion_youtube.load import create_transcripts_from_raw_json_utterances
from src.data_ingestion_youtube.load.clean_transcripts_utterances import correct_typos_in_files
from src.utils.utils import timeit, root_directory, start_logging, save_successful_load_to_csv, compute_new_entries, save_metadata_to_pipeline_dir
...
def load_single_video_transcript(youtube_videos_df, file_path):
    try:
        ...
        from src.custom_pymupdfreader.base import PyMuPDFReader
